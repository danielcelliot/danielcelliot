...
INSERT INTO country
    (country_code, country_name, created_by, last_updated_by)
VALUES
    ('TT', 'Trinidad & Tobago', 1, 1);

ALTER TABLE country
    MODIFY created_by
		TINYINT UNSIGNED
        NOT NULL,
    MODIFY last_updated_by
		TINYINT UNSIGNED
        NOT NULL;
...
INSERT INTO gender
    (gender_type, created_by, last_updated_by)
VALUES
    ('Male', 1, 1),
    ('Female', 1, 1);
...
INSERT INTO staff
    (first_name, last_name, date_of_birth, nationality, gender_id, created_by, last_updated_by)
VALUES
    ('Daniel', 'Elliot', '1986-09-20', 1, 1, 1, 1),
    ('Rachel', 'Elliot', '1984-09-20', 1, 2, 1, 1);
