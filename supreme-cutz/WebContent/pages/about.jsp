...
<head>
    ...
    <title>About - Supreme Cutz Barbershop</title>
    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="regular-wrapper">
                <div class="details">
                    <p>Supreme Cutz Barbershop mixes excellent service with the new style appeal of an experienced and talented staff. 
                    From the diverse styles and personalities of our stylists and barbers, to our signature poster wall plastered with a 
                    time machine of music legends and icons, Supreme Cutz Barbershop is a place where the music is worth turning up, and where 
                    everyone can proudly let their individuality shine. We want each experience at Supreme Cutz Barbershop to be as unique and 
                    authentic as the people who fill the shop.</p>
                </div>
            </div>

            <div class="parallax-wrapper-1">
                <div class="content">
                    <h1>Dedicated to Excellence</h1>
                </div>
            </div>

            <div class="regular-wrapper-1">
                <div class="details">
                    <p>We offer a full menu of services for everyone, including haircuts, hair color, fades, beard trims, straight razor shaves, 
					and signature massage shampoo, finishing every service with a relaxing shoulder massage. We provide a great service, a 
                    unique, high-energy vibe, and haircuts with an unbeatable value. The Supreme Cutz Barbershop experience is truly one of a kind.</p>
                </div>
            </div>
