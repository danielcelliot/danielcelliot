...
<head>
    ...
    <title>Shopping Cart - Supreme Cutz Barbershop</title>
    ...
    <div class="container">
        ...
        <main>
            <div class="shopping-cart">
				...
				%>
				<!-- Empty cart -->
                <div class="item empty-cart">
                    <p>Your shopping cart is empty. Click <a href="./products.jsp">here</a> to start shopping!</p>
                </div>
                <%
				} else {
				%>
				...
				<!-- Empty cart -->
                <div class="item empty-cart empty">
                    <p>Your shopping cart is empty. Click <a href="./products.jsp">here</a> to start shopping!</p>
                </div>
				...
				<%
					...
					while (i.hasNext()) {
		                ...
		                String query = "select * from product where product_id =" + i.next() + "";
		                ...
		                while(rs.next()) {
		                	...
		                	<div class="item">
			                    <div class="buttons">
			                        <i class="far fa-window-close close-btn"  id="<%=rs.getString("product_id")%>"></i>
			                    </div>
			                    
								<div class="image">
			                    <%
								Blob imageBlob = rs.getBlob("image_small");
			                    ...
			                    <div class="quantity">
			                        ...
			                        <input class="qty-value id <%=rs.getString("product_id") %>" data-stock-amt="<%=rs.getString("stock_amt") %>" data-weight="<%=rs.getString("weight") %>" type="text" name="name" value="1" readonly>
			                        <button class="minus-btn" type="button" name="button">
			                            <i class="far fa-minus-square"></i>
			                        </button>
			                    </div>
			                    <div style="display: none;"><span class="unit-price"><%=rs.getString("unit_price") %></span></div>
			                    <div class="subtotal">$<span class="subtotal-value"><%=rs.getString("unit_price") %></span></div>
			                </div>
                ...
                <div class="item totals">
                    <div>
                        <div style="margin-bottom: 0.15em;">
                            <span class="subtotal-text">Subtotal: $</span><span id="subtotal-value">00.00</span>
                        </div>
                        
                        <div style="margin-bottom: 1em;">
                            <span class="shipping-text">Shipping: $</span><span id="shipping-value">00.00</span>
                        </div>
                        <div>
                            <span class="total-text" style="font-size: 22px;">Total: </span><span style="font-size: 22px; color: red; font-weight: 600;">$</span><span id="total-value" style="font-size: 22px; color: red; font-weight: 600;">0.00</span>
                        </div>
                    </div>
                    <div>
