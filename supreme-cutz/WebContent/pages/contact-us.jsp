...
<head>
    ...
    <title>Contact Us - Supreme Cutz Barbershop</title>
		    	...
		    	<div class="modal-content modal-flex">
		    		<div class="modal-header">
		    			<span class=""><i class="fas fa-check-circle"></i></span>
	      				<h3 class="modal-header-text" id="success-heading">Message Received</h3>
		    		</div>
		    		<div class="modal-body">
		    			<p id="success-msg" class="modal-msg">Your messaged has been received. You will be contacted within 48 hours</p>
		    		</div>
        ...
        <nav class="sidebar-nav">
            <div class="nav-wrapper">
                <ul class="nav-vert">
                    ...
                    <li><a href="#" class="page-link">contact us</a></li>
        ...
        <main>
            <div class="banner">
                ...
                <div class="caption">
                    ...
                    <p>Open 7 Days a Week | Book An Appointment Today</p>
                </div>
            </div>
            <div class="card">
                <div class="card-details">
                    <h3>Opening Hours</h3>
                    <p>Mon. Tues. Wed. 10am - 6.30pm</p>
                    <p>Thurs. Fri. 10am - 7pm</p>
                    <p>Saturday. 9am - 6pm</p>
                    <p>Sunday. 11am - 4pm</p>

                    <div class="img-container">
                        <img src="../img/barber-shop/entrance.png" alt="" srcset="">
                    </div>

                    <p class="location-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc elementum imperdiet purus, 
                        eget laoreet nulla blandit et. Nunc est nisl, vestibulum vitae tortor id, feugiat molestie odio. 
                        Sed volutpat eros sed arcu sodales feugiat.</p>
                </div>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3921.2653924539636!2d-61.27688668525226!3d10.636478792416613!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8c49ff76b425da8f%3A0xddcf60ae0a3b2929!2sFiddlers%20Dream%20St%2C%20Arima!5e0!3m2!1sen!2stt!4v1570925848968!5m2!1sen!2stt" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
            </div>

            <div class="contact-form-container">
                <h3>We want to hear from you!</h3>
                <p>If you want to find out more about our services and products or provide feedback, feel free to message us!</p>
                <form action="../scriptlets/submitFeedback.jsp" name="feedbackForm" method="post">
                    <div class="input-container">
                        ...
                        <div class="wrap-input input-half">
                            <input type="tel" name="phone" placeholder="Phone (#######)" pattern="^(\d{7})$" required>
                        </div>
                        <div class="wrap-input input-full wide">
                            <textarea id="messageText" name="message" placeholder="Write your message here..." required></textarea>
                        </div>
                    </div>
