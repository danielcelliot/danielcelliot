...
<head>
    ...
    <title>Profile - Supreme Cutz Barbershop</title>
        ...
        <main>
            <div class="profiles-wrapper">
                <div class="profiles-info">
                    <img class="portrait" src="../../img/barbers/kevon.jpg" alt=""/>
                    <div class="profiles-text">
                        <p>Kevon Wilson <span>Creative Director</span> | <span>Hair Stylist</span></p>
                        <a href="mailto:kevonw@supremecutz.com"><i class="fas fa-envelope"></i>Email me</a>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec porttitor elit massa, 
                            et accumsan ligula luctus ac. Mauris vitae dictum diam. Pellentesque tellus lorem, 
                            imperdiet in ullamcorper egestas, condimentum nec est. Nunc laoreet sem ligula. 
                            Suspendisse nibh purus, placerat eu ultrices ut, tincidunt eget lectus. Integer magna 
                            nibh, volutpat eget mollis vel, faucibus vel orci. Suspendisse finibus sed sapien at 
                            dictum. Integer eget ex porttitor, consequat nunc eget, luctus neque. Vivamus lobortis 
                            sodales magna, id scelerisque ligula faucibus non. In pellentesque neque non cursus 
                            venenatis. Aenean porta orci vel dolor dictum placerat vel vitae nibh. Proin nunc lorem, 
                            condimentum et suscipit convallis, dignissim sed quam. Donec a hendrerit velit, eu 
                            maximus purus.</p>
    
                        <p>Phasellus aliquam sodales rutrum. Fusce nec lacus mauris. In convallis nibh ac magna 
                            rhoncus tristique. Curabitur vitae dui odio. Aliquam congue dictum lacus ac ultrices. 
                            Sed dictum viverra volutpat. Donec vel laoreet massa. Cras sit amet varius metus, vel 
                            faucibus lectus. Phasellus congue enim lobortis ullamcorper tincidunt. Proin vel turpis 
                            sit amet libero efficitur venenatis nec consectetur diam. Suspendisse tempus dui sem, 
                            et convallis tellus scelerisque ut.</p>
                    </div>
                </div>
                <div class="profiles-gallery">
                    <span>My work:</span>
                    <div class="m-p-g">
                        <div class="m-p-g__thumbs" data-google-image-layout data-max-height="150">
                            <img src="../../img/barbers/profile-2/01-thumb.jpg" data-full="../../img/barbers/profile-2/01.jpg" class="m-p-g__thumbs-img" />
                            <img src="../../img/barbers/profile-2/02-thumb.jpg" data-full="../../img/barbers/profile-2/02.jpg" class="m-p-g__thumbs-img" />
                            <img src="../../img/barbers/profile-2/03-thumb.jpg" data-full="../../img/barbers/profile-2/03.jpg" class="m-p-g__thumbs-img" />
                            <img src="../../img/barbers/profile-2/04-thumb.jpg" data-full="../../img/barbers/profile-2/04.jpg" class="m-p-g__thumbs-img" />
                            <img src="../../img/barbers/profile-2/05-thumb.jpg" data-full="../../img/barbers/profile-2/05.jpg" class="m-p-g__thumbs-img" />
                        </div>
