...
<head>
    ...
    <title>Barbers - Supreme Cutz Barbershop</title>
    ...
    <div class="container">
        ...
        <nav class="sidebar-nav">
            <div class="nav-wrapper">
                <ul class="nav-vert">
                    ...
                    <li><a href="#" class="page-link">barbers</a></li>
        ...
        <main>
            <div class="banner">
                ...
                <div class="caption">
                    <h2>Meet the team</h2>
                    <p>Over 15 Years Experience | Explore Our Profiles</p>
                </div>
            </div>
            ...
            <div class="profile-wrapper">
                <section class="profile">
                    <div class="profile-pic">
                        <img src="../img/barbers/isaac.png" alt="">
                    </div>
                    <div class="profile-details">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc elementum imperdiet purus, 
                            eget laoreet nulla blandit et. Nunc est nisl, vestibulum vitae tortor id, feugiat molestie odio. 
                            Sed volutpat eros sed arcu sodales feugiat. Sed enim risus, maximus quis blandit eu, maximus in est. Nullam nec lorem tincidunt, viverra 
                            velit eu, rutrum dolor. Praesent nec mattis nulla.
                        </p>
                        <div class="profile-personal">
                            <p>Isaac Gibson <span>Master Barber</span> | <span>Co-Founder</span></p>
                        </div>
                        <a class="view-profile-btn" href="./profiles/profile-1.jsp">View profile</a>
                    </div>
                </section>
            </div>
            ...
            <div class="profile-wrapper">
                <section class="profile">
                    <div class="profile-pic">
                        <img src="../img/barbers/kevon.jpg" alt="">
                    </div>
                    <div class="profile-details">
                        <p>Sed enim risus, maximus quis blandit eu, maximus in est. Nullam nec lorem tincidunt, viverra 
                            velit eu, rutrum dolor. Praesent nec mattis nulla.
                        </p>
                        <p>Sed enim risus, maximus quis blandit eu, maximus in est. Nullam nec lorem tincidunt, viverra 
                            velit eu, rutrum dolor. Praesent nec mattis nulla.
                        ...
                        <a class="view-profile-btn" href="./profiles/profile-2.jsp">View profile</a>
                    </div>
                </section>
            </div>
            ...
            <div class="profile-wrapper">
                <section class="profile">
                    <div class="profile-pic">
                        <img src="../img/barbers/mikey.png" alt="">
                    </div>
                    <div class="profile-details">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc elementum imperdiet purus.</p>
                        <p>Sed enim risus, maximus quis blandit eu, maximus in est. Nullam nec lorem tincidunt, viverra 
                            velit eu, rutrum dolor. Praesent nec mattis nulla.
                        </p>
                        <div class="profile-personal">
                        ...
                        <a class="view-profile-btn" href="./profiles/profile-3.jsp">View profile</a>
                    </div>
                </section>
            </div>
            ...
            <div class="profile-wrapper">
                <section class="profile">
                    <div class="profile-pic">
                        <img src="../img/barbers/carl.png" alt="">
                    </div>
                    <div class="profile-details">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc elementum imperdiet purus, 
                            eget laoreet nulla blandit et. Nunc est nisl, vestibulum vitae tortor id, feugiat molestie odio. 
                            Sed volutpat eros sed arcu sodales feugiat.
                        </p>
                        <div class="profile-personal">
                            <p>Carl Mohammed <span>Junior Barber</span> | <span>Hair Stylist</span></p>
                        </div>
                        <a class="view-profile-btn" href="./profiles/profile-4.jsp">View profile</a>
                    </div>
                </section>
            </div>
        </main>
