...
<%@ page import="com.supremecutz.bean.Product"%>
...
<html lang="en">
    <head>
        ...
        <title>Products - Supreme Cutz Barbershop</title>
        ...
        <div class="container">
            ...
            <nav class="sidebar-nav">
                <div class="nav-wrapper">
                    <ul class="nav-vert">
                        ...
                        <li><a href="#" class="page-link">products</a></li>
                    </ul>
                </div>
            </nav>
            ...
            <main>
                <div class="banner">
                    ...
                    <div class="caption">
                        <h2>Proudly made in t&t</h2>
                        <p>High Quality Products | Place Your Order Online</p>
                    </div>
                </div>
                ...
                <div class="products-container">
                    <ul class="products-list">
						...
						<li data-index="" class="product-card">
							<%
							Blob imageBlob = rs.getBlob("image_med");
                            ...
                            <%
                            if (rs.getInt("stock_amt") != 0) {
                           	%>
	                           	<button class="add-to-cart mouse-over" id="<%=rs.getString("product_id")%>">
                            ...
                            <%
                           	...
                           	%>
                            	<button class="no-stock" id="<%=rs.getString("product_id")%>">
                            ...
                            <div class="stats">        	
                                <div class="stats-container">
                                    <div class="product-desc">
                                        <span class="product-name"><%=rs.getString("brand")%></span>  
                                        <span class="product-price">$<%=rs.getString("unit_price")%></span>
                                    </div>
                                    ...
                                    <strong>ITEM FEATURE 1</strong>
                                    <span><%=features[0]%></span>
                                    <strong>ITEM FEATURE 2</strong>
                                    <span><%=features[1]%></span>
                                    <strong>IN STOCK</strong>
                                    <span><%=rs.getString("stock_amt") %></span>
                                    <strong>ITEM WEIGHT</strong>
                                    <span><%=rs.getString("weight") %> lbs.</span>
                                </div>
                            </div>
                        </li>
